...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/dashboard/addEvents', 'HomeController@addEvents')->name('addEvents');
    Route::get('/dashboard/getEvents', 'HomeController@getEvents')->name('getEvents');
    Route::get('/dashboard/delEvents', 'HomeController@delEvents')->name('delEvents');
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::group(['prefix' => 'users'], function(){
            ...
            Route::get('teacher_list', 'UserController@teacherList')->name('users.teacher_list');
            Route::get('admin_list', 'UserController@adminList')->name('users.admin_list');
            
            Route::get('getAllowances', 'UserController@getAllowances')->name('users.getAllowances');
            Route::get('setAllowances', 'UserController@setAllowances')->name('users.setAllowances');
            Route::get('delAllowances', 'UserController@delAllowances')->name('users.delAllowances');
            
            Route::get('getResponsibilityAllowances', 'UserController@getResponsibilityAllowances')->name('users.getResponsibilityAllowances');
            Route::get('setResponsibilityAllowances', 'UserController@setResponsibilityAllowances')->name('users.setResponsibilityAllowances');
            Route::get('delResponsibilityAllowances', 'UserController@delResponsibilityAllowances')->name('users.delResponsibilityAllowances');
        });
