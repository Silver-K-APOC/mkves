    ...
    public function store(UserRequest $req)
    {
        ...
        if($user_type == 'teacher'){
            ...
            $value = DB::table('user_details')->insert([
                ...
                'date_of_joining' => date('m/d/Y',strtotime($req->date_of_joining)),
                'type_of_contract' => $req->type_of_contract,
                'marital_status' => $req->marital_status,
                'religion' => $req->religion,
                'date_of_birth' => date('m/d/Y',strtotime($req->date_of_birth)),
                ...
                'passport_issue_date'=> date('m/d/Y', strtotime($req->passport_issue_date)),
                'passport_expiry_date'=> date('m/d/Y', strtotime($req->passport_expiry_date)),
                
                'visa_no'=> $req->visa_no,
    
                'uid_no'=> $req->uid_no,
                'uid_issue_date'=> date('m/d/Y', strtotime($req->uid_issue_date)),
                'uid_expiry_date'=> date('m/d/Y', strtotime($req->uid_expiry_date)),
    
                'emirates_id_no'=> $req->emirates_id_no,
                'emirates_expiry'=> date('m/d/Y', strtotime($req->emirates_expiry)),
                
                'labour_card_no'=> $req->labour_card_no,
                'labour_expiry'=> date('m/d/Y', strtotime($req->labour_expiry)),
                ...
                'medical_expiry_date'=> date('m/d/Y', strtotime($req->medical_expiry_date)),
